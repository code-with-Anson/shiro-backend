...
import com.shiro.main.service.IBillsService;
...
public class BillsServiceImpl extends ServiceImpl<BillsMapper, Bills> implements IBillsService {
     ...
     */
    @Override
    @CacheEvict(value = CACHE_NAMESPACE, key = "T(com.shiro.main.utils.UserContext).getUser()  + ':' + #addBillsDTO.date.year + '-' + #addBillsDTO.date.monthValue")
    ...
    @Cacheable(
            ...
            key = "T(com.shiro.main.utils.UserContext).getUser() + ':' + #queryMonthBillsDTO.year + '-' + #queryMonthBillsDTO.month",
     ...
     */
    @Override
    @CacheEvict(value = CACHE_NAMESPACE, key = "T(com.shiro.main.utils.UserContext).getUser() + ':' + #updateBillsDTO.date.year + '-' + #updateBillsDTO.date.monthValue")
