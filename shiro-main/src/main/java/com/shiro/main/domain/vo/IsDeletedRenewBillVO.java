 ...
 */
@Data
@ApiModel(value = "查询用户被逻辑删除的循环账单-VO实体")
public class IsDeletedRenewBillVO implements Serializable {
     ...
     * @return
     */
    public static IsDeletedRenewBillVO toVO(RenewBill renewBill) {
        IsDeletedRenewBillVO vo = new IsDeletedRenewBillVO();
